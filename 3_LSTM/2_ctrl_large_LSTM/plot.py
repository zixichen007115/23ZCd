...
img_dir = "../../0_files/data_large/img_" + config.task
...
plt.savefig("../../0_files/data_large/" + config.task + "_diagram.png")
plt.close()
...
imageio.mimsave("../../0_files/data_large/" + config.task, frames, 'GIF', duration=0.1)
