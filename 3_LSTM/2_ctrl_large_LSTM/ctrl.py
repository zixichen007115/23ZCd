...
if not os.path.exists("../../0_files/data_large"):
    os.mkdir("../../0_files/data_large")
...
np.savez('../../0_files/data_large/data_'+config.task, pos_list=pos_list, dir_list=dir_list, act_list=act_list,
