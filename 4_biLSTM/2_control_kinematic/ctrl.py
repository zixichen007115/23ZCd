...
if not os.path.exists("../../0_files/data_bi"):
    os.mkdir("../../0_files/data_bi")
...
np.savez('../../0_files/data_bi/data_'+config.task, pos_list=pos_list, dir_list=dir_list, act_list=act_list,
