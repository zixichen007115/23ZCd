...
data = np.load('../../0_files/data_bi/data_' + config.task + ".npz")
...
img_dir = "../../0_files/data_bi/img_" + config.task
...
plt.savefig("../../0_files/data_bi/" + config.task + "_diagram.png")
plt.close()
...
imageio.mimsave("../../0_files/data_bi/" + config.task, frames, 'GIF', duration=0.1)
